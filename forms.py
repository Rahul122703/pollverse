...
class CommentForm(FlaskForm):
    head = StringField( validators=[DataRequired()], render_kw={"placeholder": "Enter heading"}, label= False)
    body = CKEditorField('Body', validators=[DataRequired()], label= False)
    bg_image = URLField('Enter background image URL',render_kw={"placeholder": "Enter background image URL"}, label= False)
